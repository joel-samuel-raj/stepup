            ...
            <AnimatePresence exitBeforeEnter>
                { next ? ( <motion.div key='step1' initial={ { opacity: 0, x: "200px" } } animate={ { opacity: 1, x: "0px" } } exit={ { opacity: 0, x: "-200px" } } transition={{duration: 0.2}}>
                    <div className='flex flex-col justify-center items-baseline'>
                        ...
                        <div className="my-4 flex justify-center items-center">
                            <Badge
                                ...
                                badgeContent={
                                    <IconButton className='p-4 bg-white hover:bg-white'>
                                        <FontAwesomeIcon className='text-sm' icon={ faUpload } />
                                    </IconButton>
                                }>
                    ...
                    <form className='w-full' onSubmit={ formik.handleSubmit }>
                        ...
                        />
                        <Button onClick={ () => setNext( true ) } className='my-4'  variant="contained" fullWidth type="submit">
                            Create Account
                        </Button>
                    </form>
                    <Button className='mt-5' fullWidth variant='outlined'>
